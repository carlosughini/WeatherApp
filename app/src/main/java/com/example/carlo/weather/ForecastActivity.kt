            ...
            override fun onResponse(call: Call<Weather>?, response: Response<Weather>?) {
                ...
                if (forecasts != null) {
                    for (forecast in forecasts) {
                        var lineText = "${forecast.date} - High: ${forecast.high} Low: ${forecast.low} - ${forecast.text}"
                ...
                val adapter = ArrayAdapter(this@ForecastActivity,android.R.layout.simple_list_item_1,forecastStrings)
